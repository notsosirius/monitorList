    ...
    return __extends(h, s), h.newClobOfLocal = function(r, i) {
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(t) {
                switch (t.label) {
                  case 0:
                    return (r = new h(n, e, s, o)).storageType !== abstractLob_1.AbstractLob.STORAGE_IN_ROW ? [ 3, 1 ] : (i = r.getHeadSize(), 
                    r.data = bufferUtil_1.BufferUtil.u(n, i, Number(r.bytesLength), r.serverEncoding), 
                    r.length = r.data.length, [ 3, 3 ]);
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(t) {
                switch (t.label) {
                  case 0:
                    return (this.checkFreed(), this.local || this.storageType === abstractLob_1.AbstractLob.STORAGE_IN_ROW || this.fetchAll) ? [ 2 ] : (i = (r = this).getSubString, 
                  ...
                  case 2:
                    return r.data = t.sent(), this.length = this.data.length, this.fetchAll = !0, [ 2 ];
                }
            });
        });
            ...
            return __generator(this, function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    ...
                    if (n = r < n ? r : n, this.local || this.storageType === abstractLob_1.AbstractLob.STORAGE_IN_ROW || this.fetchAll) {
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    return this.conn.checkClosed(), [ 4, this.conn.access.A(this, n, e, this.serverEncoding) ];

                  case 2:
                    i = t.sent(), this.storageType === abstractLob_1.AbstractLob.STORAGE_IN_ROW && this.setLocalData(n, e), 
                    r = i, t.label = 3;
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    r.length = t.sent(), this.storageType === abstractLob_1.AbstractLob.STORAGE_IN_ROW && (this.data = this.data.slice(0, this.length)), 
                    t.label = 3;
